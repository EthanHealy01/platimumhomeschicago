  ...
  properties: [
    {
      ...
      specs: { beds: "", baths: "", sqft: "", units: "", buildingType: "", garage: "" },
      media: {
        kind: "folder",
    ...
    },
    {
      ...
      price: "Sold out",
      description: "8 condos — fully sold out.",
      estimatedDelivery: "Mar 2026",
      links: { agentName: "Tim & Bridget Sheahan", agentUrl: "https://thesheahangroup.com/" },
      dates: { start: "", end: "", sale: "" },
      specs: { beds: "", baths: "", sqft: "", units: "8", buildingType: "Condo", garage: "" },
      media: {
        kind: "folder",
    ...
    {
      slug: "2751-w-lawrence",
      name: "2751 W Lawrence",
      address: "2751 W Lawrence Ave, Chicago, IL",
      category: "past",
      published: true,
      featured: false,
      description: "",
      ...
      media: {
        kind: "folder",
        folder: "2751_w_lawrence",
        pattern: { startIndex: 1, endIndex: 12, indexPad: 2, extension: "jpg" },
        coverIndex: 12,
      },
    },
    {
      slug: "3121-n-clybourn",
      name: "3121 N Clybourn",
      address: "3121 N Clybourn Ave, Chicago, IL",
      category: "past",
      published: true,
      featured: false,
      description: "",
    ...
    {
      slug: "2604-2014-w-chicago",
      name: "2604-2014 W Chicago",
      address: "2604 - 2014 W Chicago Ave, Chicago, IL",
      category: "past",
      published: true,
      featured: false,
      description: "",
    ...
    },
    {
      ...
      dates: { start: "", end: "", sale: "" },
      specs: { beds: "", baths: "", sqft: "", units: "", buildingType: "", garage: "" },
      media: { kind: "single", file: "3121_3125_n_clybourn.png" },
    },
    {
      slug: "2215-n-halsted",
      name: "2215 N Halsted",
    ...
    },
    {
      ...
      description: "11 residential condos. 2 and 3 bed condos. Listing link coming soon.",
      estimatedDelivery: "Summer 2027",
      links: { agentName: "Jacqueline Lotzof", agentUrl: "https://www.compass.com/agents/jacqueline-lotzof/" },
      dates: { start: "", end: "", sale: "" },
      specs: { beds: "", baths: "", sqft: "", units: "11", buildingType: "Condo", garage: "" },
    ...
    },
    {
      ...
      description: "36-unit rental building with one- and two-bed units and ground floor commercial.",
      estimatedDelivery: "May 2026",
      links: { agentName: "Root Management", agentUrl: "https://www.rootrealty.com/" },
      dates: { start: "", end: "", sale: "" },
      specs: { beds: "", baths: "", sqft: "", units: "36", buildingType: "Rental, ground floor commercial", garage: "" },
      media: { kind: "single", file: "4701_n_clark_st.jpg" },
    },
    {
      slug: "1613-w-belmont-ave",
      name: "1613 W Belmont Ave",
      ...
      price: "Root management handling rentals",
      description: "11 unit rental building, commercial ground floor — 2 bed / 2 bath units.",
      links: { agentName: "Root Management", agentUrl: "https://www.rootrealty.com/" },
      dates: { start: "", end: "", sale: "" },
      specs: { beds: "", baths: "", sqft: "", units: "11", buildingType: "Rental, commercial ground floor", garage: "" },
      media: {
        kind: "folder",
    ...
    },
    {
      ...
      price: "Coming soon",
      description: "6 unit building. Renderings coming soon.",
      estimatedDelivery: "Sep 2026",
      links: { agentName: "Tim & Bridget Sheahan", agentUrl: "https://thesheahangroup.com/" },
      dates: { start: "", end: "", sale: "" },
      specs: { beds: "", baths: "", sqft: "", units: "6", buildingType: "", garage: "" },
      media: { kind: "none" },
    },
    {
      ...
      statusLabel: "Coming Soon",
      price: "Coming soon",
      description: "9 unit condo building — condos with attached parking, ground floor retail. Renderings coming soon.",
    ...
    },
    {
      ...
      price: "$4.2M",
      description: "2 new construction single-family homes side by side. Renderings coming soon.",
    ...
    },
    {
      ...
      price: "$5.2M",
      description:
        "Single-family home — 7 beds, 7 full and 2 half baths, approx. 6,000 sq ft. Renderings coming soon.",
